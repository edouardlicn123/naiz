...
解析 base_msdos5_scsi_48m.hdi 的 4096 字节头部。直接支持现有镜像是下一步所有工作的前提。
...
```python
img = HDIImage("~/msdos5/base_msdos5_scsi_48m.hdi")
...
**对 base_msdos5_scsi_48m.hdi 的预期**：
...
|------|------|------|
| `-g` | **必填** | 游戏名 |
| `-b` | `~/msdos5/base_msdos5_scsi_48m.hdi` | 基座 HDI |
| `-o` | `disks/<game>.hdi` | 输出 |
...
| 2 | `hdi.py` | `base.py` | 打开 base_msdos5_scsi_48m.hdi，检查 IPL1 |
