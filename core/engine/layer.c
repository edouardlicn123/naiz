...
/* Unify scene-end cleanup: sprites, cursor, screen, layers.
 ...
 * NOTE: audio_stop_all() was moved OUT of here into scene_switch()
 * (stage 2 E) so audio teardown belongs to the scene-switch path. */
