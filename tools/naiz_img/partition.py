...
def detect_mbr(img):
    if img.sector_size < 512:
        raise ValueError(
            f'MBR partition table requires 512-byte sectors, got {img.sector_size}')
